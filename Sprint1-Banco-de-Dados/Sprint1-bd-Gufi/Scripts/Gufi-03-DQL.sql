...
-- Outro Jeito --
SELECT e.NomeEvento, e.DataEvento, e.Descricao, e.AcessoLivre, i.NomeFantasia
FROM Evento e, Instituicao i
WHERE e.IdEvento = i.idInstituicao
GO
