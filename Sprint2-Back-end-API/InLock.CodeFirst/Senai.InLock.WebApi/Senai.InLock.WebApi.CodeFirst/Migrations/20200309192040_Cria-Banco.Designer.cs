...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309192040_Cria-Banco")]
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "É um jogo bacana!", IdEstudio = 1, NomeJogo = "Diablo 3", Valor = 99.99m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Jogo legal!", IdEstudio = 2, NomeJogo = "Read Redemption II", Valor = 120.00m }
                    );
                });
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { IdUsuario = 2, Email = "cliente@cliente", IdTipoUsuario = 2, Senha = "cliente" }
                    );
                });
