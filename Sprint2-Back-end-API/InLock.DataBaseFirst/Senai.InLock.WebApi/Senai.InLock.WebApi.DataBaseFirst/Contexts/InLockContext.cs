...
namespace Senai.InLock.WebApi.DataBaseFirst.Domains
{
    ...
    public partial class InLockContext : DbContext
    {
        ...
        public virtual DbSet<TiposUsuario> TipoUsuario { get; set; }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-BEVTDEI\\TSQLEXPRESS; Database=InLock_Games_Tarde; user Id=sa; pwd=sa@123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TiposUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__TipoUsu__7B406B561DC05EA1")
                    .IsUnique();
