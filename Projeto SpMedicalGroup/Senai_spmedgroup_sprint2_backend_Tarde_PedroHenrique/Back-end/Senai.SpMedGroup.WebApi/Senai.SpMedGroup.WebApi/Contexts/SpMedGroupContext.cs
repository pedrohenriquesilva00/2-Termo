...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-BEVTDEI\\TSQLEXPRESS; Initial Catalog=SpMedGroup_Tarde; user Id=sa; pwd=sa@123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Paciente>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cpf)
                    .HasName("UQ__Paciente__C1F8973135E61553")
                    .IsUnique();

                entity.HasIndex(e => e.Rg)
                    .HasName("UQ__Paciente__321537C835E48C89")
                    .IsUnique();
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__TipoUsua__7B406B5667EA8B6A")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D1053411224B25")
                    .IsUnique();
